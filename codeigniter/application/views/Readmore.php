...
<body id="body">
    ...
    <div class="container">
            <div class="row bg-read">
                <div class="col-sm-8" id="colread" style="margin-top: 10px;">
                    <p class="judulcontent">Lorem Ipsum Dolor</p>
                    <p class="date">17-08-2017</p>
                    <hr id="hr">
                    <img src="assets/img/intern1.jpg" alt="Image">
    ...
    <div class="col-sm-3 samping">
                    <div id="judul2" class="judul2">
                        <h3>Popular This Week</h3>
                    </div>
                    <hr id="hr">
                    <div class="media">
                        <div class="media-left">
                            <img src="img/5.jpg" class="media-object media2" alt="image">
                        </div>
                        <div class="media-body">
                            <a href="Readmore.php"><h4 id="h4pop">Lorem ipsum dolor sit amet</h4></a>
                        </div>
                    </div>
                    <div class="media">
                        <div class="media-left">
                             <img src="img/20.jpg" class="media-object media2" alt="image">
                        </div>
                        <div class="media-body">
                            <a href="Readmore.php"><h4 id="h4pop">Lorem ipsum dolor sit amet</h4></a>
                        </div>
                    ...
                    <div class="media">
                        <div class="media-left">
                             <img src="img/24.jpg" class="media-object media2" alt="image">
                        </div>
                        <div class="media-body">
                            <a href="Readmore.php"><h4 id="h4pop">Lorem ipsum dolor sit amet</h4></a>
                        </div>
                    ...
                    <div class="media">
                        <div class="media-left">
                            <img src="img/29.png" class="media-object media2" alt="image">
                        </div>
                        <div class="media-body">
                            <a href="Readmore.php"><h4 id="h4pop">Lorem ipsum dolor sit amet</h4></a>
                        </div>
                     ...
                     <div class="media">
                        <div class="media-left">
                            <img src="img/6.jpg" class="media-object media2" alt="image">
                        </div>
                        <div class="media-body">
                            <a href="Readmore.php"><h4 id="h4pop">Lorem ipsum dolor sit amet</h4></a>
                        </div>
                    ...
                    <div class="media">
                        <div class="media-left">
                            <img src="img/7.jpg" class="media-object media2" alt="image">
                        </div>
                        <div class="media-body">
                            <a href="Readmore.php"><h4 id="h4pop">Lorem ipsum dolor sit amet</h4></a>
                        </div>
                    ...
                    <div class="media">
                        <div class="media-left">
                            <img src="img/14.png" class="media-object media2" alt="image">
                        </div>
                        <div class="media-body">
                            <a href="Readmore.php"><h4 id="h4pop">Lorem ipsum dolor sit amet</h4></a>
                        </div>
